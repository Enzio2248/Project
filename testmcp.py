...
def select_coupon(data: CouponRequest):
    ...
    โดยจะรับข้อมูลผู้ใช้งานและการจองจากผู้ใช้งาน รับ user_id, booking_id, coupon_code จากผู้ใช้งาน และทำการเลือกคูปองที่เหมาะสมเพื่อใช้ในการชำระเงิน หากคูปองหมดอายุให้เตือนผู้ใช้งานด้วย
    """
...
def add_damage(data: DamageRequest):
    ...
    และบันทึกข้อมูลความเสียหายลงในระบบเพื่อให้สามารถติดตามและจัดการความเสียหายของห้องพักได้ในอนาคต เมื่อเรียกคิดเงินให้นำค่าเสียหายที่บันทึกไว้ไปเป็นรายการที่ต้องชำระด้วย
    """
